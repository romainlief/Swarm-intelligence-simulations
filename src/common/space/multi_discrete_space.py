from .a_space.space import Space
import torch
import numbers
...
class MultiDiscreteSpace(Space):
    ...
    - Can be initialized as
        ...
        MultiDiscreteSpace([ 5, 2, 2 ]) means a space of 3 discrete spaces, where the first can take values in {0,1,2,3,4}, the second in {0,1} and the third in {0,1}
